...
@when(u'clico no submenu meus pedidos')
def step_impl(context):
    context.barraDeNavegacao.clicarSubMenuMeusPedidos()


@then(u'valido o direcionamento para a pagina meus pedidos')
def step_impl(context):
    context.barraDeNavegacao.verificarSeEstaNaPaginaMeusPedidos()
