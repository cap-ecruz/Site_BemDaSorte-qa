...
from pages.paginaCheckoutPage import PaginaCheckoutElementos
...
class HomeElementos(object):
    ...
    BANNER_PRINCIPAL_HOME_QUERO_CONCORRER = (
        By.XPATH, '/html/body/app-root/div/ng-component/main/app-home-banner-v2/figure/figcaption/span/a')
    VALOR_UNITARIO_TITULO = (By.XPATH,
                             '/html/body/app-root/div/ng-component/main/div[2]/div/app-produtos-quantidade/div/div/form/div/div[1]/div[2]')
...
class HomePage(VerificarPaginas):
    ...
    def clicarNoBotaoDoBannerPrincipalHome(self):
        self._comandos.clicar(self.elemento.BANNER_PRINCIPAL_HOME_QUERO_CONCORRER)
