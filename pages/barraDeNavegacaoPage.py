...
class BarraDeNavegacaoElementos(object):
    MENU_LOGO_BEM_DA_SORTE = (By.XPATH, '/html/body/app-root/app-header/header/nav/div/div[1]/div/a')
    ...
    MENU_RESULTADOS = (By.XPATH, '/html/body/app-root/app-header/header/nav/div/div[2]/ul[1]/li[1]/a')
    ...
    SUBMENU_MEUS_PEDIDOS = (By.XPATH, '/html/body/app-root/app-header/header/nav/div/div[3]/div/div/ul/li[4]/a')
...
class BarraDeNavegacaoPage(VerificarPaginas):
    ...
    def clicarNaLogo(self):
        self._comandos.clicar(self.elemento.MENU_LOGO_BEM_DA_SORTE)
    ...
    def clicarSubMenuMeusPedidos(self):
        self._comandos.clicar(self.elemento.SUBMENU_MEUS_PEDIDOS)
